 ...
 <section class="cta">
    ...
    <div class="box-container">
          ...
          <ul class="filter-list">
            ...
            <li>
              <button class="filter-btn">Scarf</button>
            </li>

            <li>
              <button class="filter-btn">Cardigan</button>
            </li>

            <li>
              <button class="filter-btn">Blanket</button>
            </li>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="Coat details.php">Short 101801 Icon Coat</a></h3>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="Coat details2.php">Short 101801 Icon Coat</a></h3>
                <div class="price"> $52.99 <span>$45.99</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="Coat details2.html">Wool robe coat</a></h3>
                <div class="price"> $42.99 <span>$35.99</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="Coat details2.html">Short cashmere coat</a></h3>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="./Coat details2.html">Ludmilla Icon Coat</a></h3>
                <div class="price"> $30.99 <span>$25.99</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="./Coat details2.html">Cshmere wrap coat</a></h3>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="./Coat details2.html">Pure cashmere jumper</a></h3>
                <div class="price"> $12.99 <span>$15.99</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="./Coat details2.html"></a>Oversize cardigan</h3>
                <div class="price"> $22.99 <span>$15.99</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 class="h4 card-title"><a href="./Coat details2.html">Cashmere yarn jumper</a></h3>
                <div class="price"> $22.99 <span>$15.99</span> </div>
            </div>
        </div>
          ...
          <ul class="top list">
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/大衣P.png" width="100" height="125" loading="lazy"
                    alt="Fresh Orangey">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./product-details.html">Cashmere robe coat</a>
                  </h3>
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/大衣A.png" width="100" height="125" loading="lazy" alt="key Lime">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./product-details.html">Strappy coat</a>
                  </h3>
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/毛衣1.png" width="100" height="125" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./wool coat.html">Cashmere short jumper</a>
                  </h3>
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/大衣Z.png" width="100" height="125" loading="lazy" alt="Stobery">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./wool coat.html">Short cashmere coat</a>
                  </h3>
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/毛衣3.png" width="100" height="125" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./wool coat.html">Oversize wool</a>
                  </h3>
            ...
            <li class="top-item">
              <div class="top-card">
                ...
                <figure class="card-banner">
                  <img src="images/gift.png" width="100" height="125" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <h3 class="h4 card-title">
                    <a href="./wool coat.html">Silk floral brooch</a>
                  </h3>
