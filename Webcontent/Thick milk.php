      ...
      <section class="section product-details">
        <div class="container">
          ...
          <div class="wrapper">
            ...
            <div class="product-details-img">
              ...
              <figure class="product-display">
                <img src="images/厚酸奶.jpg" width="700" height="700" 
              ...
              <ul class="product-thumbnail-list has-scrollbar">
                ...
                <li class="product-thumbnail-item">
                  <img src="images/酸细节1.jpg" width="700" height="700" 
                    alt="Non-starchy vegetables." class="w-100" data-product-thumbnail>
                </li>

                <li class="product-thumbnail-item">
                  <img src="images/酸细节2.jpg" width="700" height="700" 
                    alt="Non-starchy vegetables." class="w-100" data-product-thumbnail>
                </li>

                <li class="product-thumbnail-item">
                  <img src="images/酸细节3.jpg" width="700" height="700" 
                    alt="Non-starchy vegetables." class="w-100" data-product-thumbnail>
                </li>
            ...
            <div class="product-details-content">
              ...
              <h3 class="product-title">Thick and sour goat's milk</h3>

              <data class="product-price" value="350.00">7.60 USD</data>
              ...
              <p class="product-text">
				Thick Yoghurt is a rich and nutritious yoghurt product. We are committed to providing high quality dairy products that bring consumers delicious and healthy choices. We use fresh and high quality milk as the raw material for making Thick Yoghurt. The milk is sterilised at high temperatures to retain the natural nutrients of the milk and is made into a thick thick yoghurt through a special process.
			</p>
          ...
          <p class="description-text">
           Thick yoghurt has a rich flavour and smooth texture. Its unique taste makes it a delightful dietary treat. We offer a wide range of thick yoghurt flavours, including plain, strawberry, blueberry and vanilla. Each flavour is carefully blended to provide consumers with a diverse range of choices to meet the needs of different tastes. Our thick yoghurt is free from artificial additives, preservatives and artificial colours. We focus on the healthiness of our products and are committed to providing consumers with all-natural, additive-free dairy products. Packed in convenient single-serving packs, it is easy to carry and consume. You can enjoy healthy and tasty thick yoghurt anytime and anywhere.
          </p>
